package asfiles.encoding
{
    ...
    public class JPEGEncoder extends Object
    {
        ...
        private function RGB2YUV(param1:BitmapData, param2:int, param3:int)
        {
            var _loc_4:int = 0;
            var _loc_5:int = 0;
            var _loc_6:int = 0;
        ...
        private function writeWord(param1:int)
        {
        ...
        private function writeByte(param1:int)
        {
        ...
        private function writeDHT() : void
        {
            ...
            while (_loc_2 <= 11)
            {
                ...
                writeByte(std_dc_luminance_values[_loc_2]);
                _loc_2++;
            }
            writeByte(16);
            _loc_3 = 0;
            while (_loc_3 < 16)
            {
                ...
                writeByte(std_ac_luminance_nrcodes[(_loc_3 + 1)]);
                _loc_3++;
            }
            _loc_4 = 0;
            while (_loc_4 <= 161)
            {
                ...
                writeByte(std_ac_luminance_values[_loc_4]);
                _loc_4++;
            }
            writeByte(1);
            _loc_5 = 0;
            while (_loc_5 < 16)
            {
                ...
                writeByte(std_dc_chrominance_nrcodes[(_loc_5 + 1)]);
                _loc_5++;
            }
            _loc_6 = 0;
            while (_loc_6 <= 11)
            {
                ...
                writeByte(std_dc_chrominance_values[_loc_6]);
                _loc_6++;
            }
            writeByte(17);
            _loc_7 = 0;
            while (_loc_7 < 16)
            {
                ...
                writeByte(std_ac_chrominance_nrcodes[(_loc_7 + 1)]);
                _loc_7++;
            }
            _loc_8 = 0;
            while (_loc_8 <= 161)
            {
                ...
                writeByte(std_ac_chrominance_values[_loc_8]);
                _loc_8++;
            }
            return;
        }// end function
        ...
        private function initCategoryNumber()
        {
            ...
            while (_loc_3 <= 15)
            {
                ...
                while (_loc_4 < _loc_2)
                {
                    ...
                    category[32767 + _loc_4] = _loc_3;
                    bitcode[32767 + _loc_4] = new BitString();
                    bitcode[32767 + _loc_4].len = _loc_3;
                    bitcode[32767 + _loc_4].val = _loc_4;
                    _loc_4++;
                }
                _loc_5 = -(_loc_2 - 1);
                while (_loc_5 <= -_loc_1)
                {
                    ...
                    category[32767 + _loc_5] = _loc_3;
                    bitcode[32767 + _loc_5] = new BitString();
                    bitcode[32767 + _loc_5].len = _loc_3;
                    bitcode[32767 + _loc_5].val = (_loc_2 - 1) + _loc_5;
                    _loc_5++;
                }
                _loc_1 = _loc_1 << 1;
                _loc_2 = _loc_2 << 1;
        ...
        private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
        {
            ...
            _loc_6 = param5[0];
            _loc_7 = param5[240];
            _loc_8 = fDCTQuant(param1, param2);
            _loc_9 = 0;
            while (_loc_9 < 64)
            {
                
                DU[ZigZag[_loc_9]] = _loc_8[_loc_9];
                _loc_9++;
            }
            _loc_10 = DU[0] - param3;
            param3 = DU[0];
            ...
            while (_loc_12 <= _loc_11)
            {
                ...
                _loc_13 = _loc_12;
                while (DU[_loc_12] == 0 && _loc_12 <= _loc_11)
                {
                ...
                {
                    _loc_15 = 1;
                    while (_loc_15 <= _loc_14 / 16)
                    {
                        
                        writeBits(_loc_7);
                        _loc_15++;
                    }
                    _loc_14 = int(_loc_14 & 15);
                }
                writeBits(param5[_loc_14 * 16 + category[32767 + DU[_loc_12]]]);
                writeBits(bitcode[32767 + DU[_loc_12]]);
                _loc_12++;
            }
            if (_loc_11 != 63)
            {
        ...
        private function initQuantTables(param1:int) : void
        {
            ...
            var _loc_10:Number = NaN;
            var _loc_11:int = 0;
            _loc_2 = [16, 11, 10, 16, 24, 40, 51, 61, 12, 12, 14, 19, 26, 58, 60, 55, 14, 13, 16, 24, 40, 57, 69, 56, 14, 17, 22, 29, 51, 87, 80, 62, 18, 22, 37, 56, 68, 109, 103, 77, 24, 35, 55, 64, 81, 104, 113, 92, 49, 64, 78, 87, 103, 121, 120, 101, 72, 92, 95, 98, 112, 100, 103, 99];
            _loc_3 = 0;
            while (_loc_3 < 64)
            {
                
                _loc_9 = Math.floor((_loc_2[_loc_3] * param1 + 50) / 100);
                if (_loc_9 < 1)
                {
                    _loc_9 = 1;
                }
                ...
                YTable[ZigZag[_loc_3]] = _loc_9;
                _loc_3++;
            }
            _loc_4 = [17, 18, 24, 47, 99, 99, 99, 99, 18, 21, 26, 66, 99, 99, 99, 99, 24, 26, 56, 99, 99, 99, 99, 99, 47, 66, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99];
            _loc_5 = 0;
            while (_loc_5 < 64)
            {
                
                _loc_10 = Math.floor((_loc_4[_loc_5] * param1 + 50) / 100);
                if (_loc_10 < 1)
                {
                    _loc_10 = 1;
                }
            ...
            while (_loc_8 < 8)
            {
                ...
                while (_loc_11 < 8)
                {
                    ...
                    fdtbl_Y[_loc_7] = 1 / (YTable[ZigZag[_loc_7]] * _loc_6[_loc_8] * _loc_6[_loc_11] * 8);
                    fdtbl_UV[_loc_7] = 1 / (UVTable[ZigZag[_loc_7]] * _loc_6[_loc_8] * _loc_6[_loc_11] * 8);
                    _loc_7++;
                    _loc_11++;
                }
                _loc_8++;
        ...
        private function fDCTQuant(param1:Array, param2:Array) : Array
        {
            ...
            while (_loc_4 < 8)
            {
                ...
                _loc_7 = param1[_loc_3 + 0] + param1[_loc_3 + 7];
                _loc_8 = param1[_loc_3 + 0] - param1[_loc_3 + 7];
                _loc_9 = param1[(_loc_3 + 1)] + param1[_loc_3 + 6];
                _loc_10 = param1[(_loc_3 + 1)] - param1[_loc_3 + 6];
                _loc_11 = param1[_loc_3 + 2] + param1[_loc_3 + 5];
                _loc_12 = param1[_loc_3 + 2] - param1[_loc_3 + 5];
                _loc_13 = param1[_loc_3 + 3] + param1[_loc_3 + 4];
                _loc_14 = param1[_loc_3 + 3] - param1[_loc_3 + 4];
                _loc_15 = _loc_7 + _loc_13;
                _loc_16 = _loc_7 - _loc_13;
                _loc_17 = _loc_9 + _loc_11;
                _loc_18 = _loc_9 - _loc_11;
                param1[_loc_3 + 0] = _loc_15 + _loc_17;
                param1[_loc_3 + 4] = _loc_15 - _loc_17;
                _loc_19 = (_loc_18 + _loc_16) * 0.707107;
                param1[_loc_3 + 2] = _loc_16 + _loc_19;
                param1[_loc_3 + 6] = _loc_16 - _loc_19;
                _loc_15 = _loc_14 + _loc_12;
                _loc_17 = _loc_12 + _loc_10;
                _loc_18 = _loc_10 + _loc_8;
                _loc_20 = (_loc_15 - _loc_18) * 0.382683;
                _loc_21 = 0.541196 * _loc_15 + _loc_20;
                _loc_22 = 1.30656 * _loc_18 + _loc_20;
                _loc_23 = _loc_17 * 0.707107;
                _loc_24 = _loc_8 + _loc_23;
                _loc_25 = _loc_8 - _loc_23;
                param1[_loc_3 + 5] = _loc_25 + _loc_21;
                param1[_loc_3 + 3] = _loc_25 - _loc_21;
                param1[(_loc_3 + 1)] = _loc_24 + _loc_22;
                param1[_loc_3 + 7] = _loc_24 - _loc_22;
                _loc_3 = _loc_3 + 8;
                _loc_4++;
            }
            _loc_3 = 0;
            ...
            while (_loc_5 < 8)
            {
                ...
                _loc_26 = param1[_loc_3 + 0] + param1[_loc_3 + 56];
                _loc_27 = param1[_loc_3 + 0] - param1[_loc_3 + 56];
                _loc_28 = param1[_loc_3 + 8] + param1[_loc_3 + 48];
                _loc_29 = param1[_loc_3 + 8] - param1[_loc_3 + 48];
                _loc_30 = param1[_loc_3 + 16] + param1[_loc_3 + 40];
                _loc_31 = param1[_loc_3 + 16] - param1[_loc_3 + 40];
                _loc_32 = param1[_loc_3 + 24] + param1[_loc_3 + 32];
                _loc_33 = param1[_loc_3 + 24] - param1[_loc_3 + 32];
                _loc_34 = _loc_26 + _loc_32;
                _loc_35 = _loc_26 - _loc_32;
                _loc_36 = _loc_28 + _loc_30;
                _loc_37 = _loc_28 - _loc_30;
                param1[_loc_3 + 0] = _loc_34 + _loc_36;
                param1[_loc_3 + 32] = _loc_34 - _loc_36;
                _loc_38 = (_loc_37 + _loc_35) * 0.707107;
                param1[_loc_3 + 16] = _loc_35 + _loc_38;
                param1[_loc_3 + 48] = _loc_35 - _loc_38;
                _loc_34 = _loc_33 + _loc_31;
                _loc_36 = _loc_31 + _loc_29;
                _loc_37 = _loc_29 + _loc_27;
                _loc_39 = (_loc_34 - _loc_37) * 0.382683;
                _loc_40 = 0.541196 * _loc_34 + _loc_39;
                _loc_41 = 1.30656 * _loc_37 + _loc_39;
                _loc_42 = _loc_36 * 0.707107;
                _loc_43 = _loc_27 + _loc_42;
                _loc_44 = _loc_27 - _loc_42;
                param1[_loc_3 + 40] = _loc_44 + _loc_40;
                param1[_loc_3 + 24] = _loc_44 - _loc_40;
                param1[_loc_3 + 8] = _loc_43 + _loc_41;
                param1[_loc_3 + 56] = _loc_43 - _loc_41;
                _loc_3++;
                _loc_5++;
            }
            _loc_6 = 0;
            while (_loc_6 < 64)
            {
                ...
                param1[_loc_6] = Math.round(param1[_loc_6] * param2[_loc_6]);
                _loc_6++;
            }
            return param1;
        }// end function
